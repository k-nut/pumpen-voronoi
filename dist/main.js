...
},{"./images/layers.png":[["layers.ac0f9a0a.png",7],7],"./images/layers-2x.png":[["layers-2x.b68a4782.png",8],8],"_css_loader":6}],2:[function(require,module,exports) {
...
var map = _leaflet2.default.map('map').setView([52.505, 13.41], 11);
...
// set up svg
function createSvg() {
  svg = d3.select(map.getPanes().overlayPane).append("svg").attr('id', 'overlay').attr("class", "leaflet-zoom-hide");
...
function positionSvg() {
  ...
  svg.style("width", map.getSize().x + 'px').style("height", map.getSize().y + 'px').style("margin-left", topLeft.x + "px").style("margin-top", topLeft.y + "px");
...
function drawLayer() {
  ...
  var filteredPoints = points.filter(function (p) {
    var latlng = new _leaflet2.default.LatLng(p.lat, p.lon);
  ...
  var svgPoints2 = svgPoints.data(convertedPoints).enter();

  svgPoints2.append("circle").attr("transform", function (d) {
  ...
  path.enter().append("path").attr("class", "part").attr("d", polygon);
}
},{"leaflet":3,"d3":4,"leaflet/dist/leaflet.css":5,"./main.css":2}],10:[function(require,module,exports) {
